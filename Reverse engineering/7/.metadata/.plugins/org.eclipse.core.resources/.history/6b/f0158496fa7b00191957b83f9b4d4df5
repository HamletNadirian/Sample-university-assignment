...
/*     */     
/*  40 */     ManifestInfo(ManifestInfo param1ManifestInfo) { this(); }
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     try {
/*  71 */       if (class$0 == null) { class$0; try {  } catch (ClassNotFoundException classNotFoundException) { throw new NoClassDefFoundError(null.getMessage()); }  }  platformClassLoader = (class$0 = Class.forName("java.lang.ClassLoader")).getMethod("getPlatformClassLoader", null);
...
/*  81 */     resEnum = Thread.currentThread().getContextClassLoader().getResources("META-INF/MANIFEST.MF");
/*  82 */     while (resEnum.hasMoreElements()) {
/*     */       try {
/*  84 */         URL url = (URL)resEnum.nextElement();
...
/*     */     } 
/* 128 */     return (String[])result.toArray(new String[result.size()]);
/*     */   }
/*     */ }


/* Location:              C:\Revers\7\Lab07Rev\lab7rev.jar!\org\eclipse\jdt\internal\jarinjarloader\JarRsrcLoader.class
