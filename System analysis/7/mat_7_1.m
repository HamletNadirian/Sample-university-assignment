...
disp('Розв’язуємо завдання 1') % виводимо заголовок задачі
...
Con=solve(EqLeft,EqRight,'C2,C3'); % розв’язуємо систему
C2=Con.C2; % прирівнюємо отриманні розв’язання
C3=Con.C3; % символічним константам C2 и C3
Sol21=vpa(eval(Sol),14); % підставили C2,C3
...
y21=subs(Sol21,x,xpl); % обчислили ординати
figure % фігура
